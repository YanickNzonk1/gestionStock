...
class UtilisateurAdmin(admin.ModelAdmin):
    list_display = ("username", "first_name", "last_name", "password", "is_staff", "is_active", "is_superuser")
...
class ClientAdmin(admin.ModelAdmin):
    list_display = ("nomEntreprise", "statut", "actif", "adresse", "ville", "pays", "telephone_client")
